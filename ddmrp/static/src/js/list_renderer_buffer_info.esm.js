...
var ListRendererBufferInfo = Component.extend({
    jsLibs: [
        "/web_widget_bokeh_chart/static/src/lib/bokeh/bokeh-3.0.0.min.js",
        "/web_widget_bokeh_chart/static/src/lib/bokeh/bokeh-api-3.0.0.min.js",
        "/web_widget_bokeh_chart/static/src/lib/bokeh/bokeh-widgets-3.0.0.min.js",
        "/web_widget_bokeh_chart/static/src/lib/bokeh/bokeh-tables-3.0.0.min.js",
        "/web_widget_bokeh_chart/static/src/lib/bokeh/bokeh-mathjax-3.0.0.min.js",
        "/web_widget_bokeh_chart/static/src/lib/bokeh/bokeh-gl-3.0.0.min.js",
    ],
    ...
    _updateNodeStyle: function ($td, record, node, color_field) {
        ...
        var classes = color_field.includes("execution") ? "circle execution" : "circle";
    ...
    _onCellClickListener: function (event) {
        ...
        this.detailDP.add(
            this._rpc({
                ...
                $(target).attr("data-content", content).data("bs.popover").setContent();
                $(target).popover("show");
...
Object.assign(ListRenderer.components, {ListRendererBufferInfo});
