...
QtyAtDatePopover.template = "ddmrp.QtyAtDatePopover";

export class StockBufferInfoWidget extends Component {
    setup() {
...
StockBufferInfoWidget.components = {Popover: QtyAtDatePopover};
StockBufferInfoWidget.template = "ddmrp.StockBufferInfoWidget";

registry.category("view_widgets").add("stock_buffer_info", StockBufferInfoWidget);
